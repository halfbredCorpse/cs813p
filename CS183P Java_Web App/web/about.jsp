<%-- 
    Document   : about
    Created on : 06 19, 18, 5:29:33 PM
    Author     : Aristan
--%>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="active menu__item menu__item--current"><a class="menu__link" href="about.jsp">About <span class="sr-only">(current)</span></a></li>
			...
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				 ...
				 <div class="col-md-6 ab_pic_w3ls_text_info">
				    <h5>About Book-O <span> Shack</span> </h5>
					<p style="text-align:justify">Established in 2018, Book-O Shack opened its first bookstore branch in Gil Puyat and has grown to 5 branches nationwide. Known for its comprehensive selection of books under every interest, the Philippine bookstore’s signature ambiance has also become a haven for thought tinkerers and readers alike.</p>
				</div>
				  <div class="clearfix"></div>
			</div>  
		</div> 
