<%-- 
    Document   : contact
    Created on : 06 19, 18, 5:33:58 PM
    Author     : Aristan
--%>
   ...
   <!--/contact-->
    <div class="banner_bottom_agile_info">
		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>333 Sen. Gil Puyat Ave., <span>Makati City 1200, Philippines</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p>+63(2) 891-0837<span>+63(2) 891-0843+1273</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:bshack@gmail.com">bshack@gmail.com</a><span><a href="mailto:bshack@yahoo.com">bshack@yahoo.com</a></span></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
	   ...
	   <div class="contact-w3-agile1 map" data-aos="flip-right">
		   <iframe src="https://maps.google.com/maps?q=mapua%20university&t=&z=13&ie=UTF8&iwloc=&output=embed" class="map" style="border:0" allowfullscreen=""></iframe> 
	   </div>
