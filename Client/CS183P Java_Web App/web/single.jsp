<%-- 
    Document   : single
    Created on : 06 19, 18, 5:37:15 PM
    Author     : Aristan
--%>
				...
				<div class="flexslider">
					...
					<ul class="slides">
						...
						<li data-thumb="images/am2.jpg">
							<div class="thumb-image"> <img src="images/amal2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="images/am3.jpg">
							<div class="thumb-image"> <img src="images/amal3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>-->
					<div class="clearfix"></div>
				</div>	
			</div>
